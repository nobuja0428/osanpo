(() => {
  ...
  const spotImageKeys = new Set(["spotKoenjiJunjo", "spotInokashiraPark", "spotSensoji"]);
  ...
  function imageMarkup(imageKey, alt, className = "") {
    const dimensions = areaImageKeys.has(imageKey)
      ...
      : courseImageKeys.has(imageKey) || spotImageKeys.has(imageKey) ? ' width="1200" height="900"' : "";
