...
export default function PlanPage() {
  return <main id="main">
    ...
    <section className="section"><div className="narrow"><PlannerClient /><div className="empty-state planner-nojs-fallback"><h2>JavaScriptが無効です</h2><p>診断を利用するにはJavaScriptを有効にしてください。公開中のコースは一覧から確認できます。</p><Link className="button button-primary" href="/courses/">コース一覧を見る</Link></div><script dangerouslySetInnerHTML={{ __html: "document.currentScript.previousElementSibling.hidden=true" }} /></div></section>
  </main>;
}
